...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-fitcode-reports': RouteRecordInfo<'apps-fitcode-reports', '/apps/fitcode/reports', Record<never, never>, Record<never, never>>,
    'apps-fitcode-trends': RouteRecordInfo<'apps-fitcode-trends', '/apps/fitcode/trends', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-fit-dash': RouteRecordInfo<'dashboards-fit-dash', '/dashboards/fit-dash', Record<never, never>, Record<never, never>>,
